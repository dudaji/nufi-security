...
| **CLI 레퍼런스** — `nufi-egress` 전 서브커맨드(플래그·예시·종료코드) | [`docs/CLI.md`](docs/CLI.md) — `nufi-egress {render,apply,disable,status,feedback,doctor,coverage,monitor,init,audit,targets,flow-tap}` |
