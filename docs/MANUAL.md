...
완전 예시는 [`examples/library_detect.py`](../examples/library_detect.py)·[`sdk_file_scan.py`](../examples/sdk_file_scan.py)·[`sdk_compliance_report.py`](../examples/sdk_compliance_report.py), API 전체
