...
- KR_ACCOUNT (n=24), SECRET (n=24): CI 하한 0.862, 목표 근접.
...
| P3 | KR_ACCOUNT·SECRET CI 마감 | 이미 CI 하한 0.862. 소폭 추가. | **S** |
