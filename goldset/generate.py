...
LISTED_SURNAMES = ["김", "이", "박", "최", "정", "강", "조", "윤", "장", "한", "오", "서", "신",
                   ...
                   # CMP-262: 사전 확장으로 수록 전환된 극희성 성씨
                   "율", "겸", "효", "몽", "잠", "절", "돈", "린", "미",
                   "능", "누", "욱", "참",
                   "어금", "망절", "황목", "소봉", "등정", "기세", "위지", "부여"]
# gazetteer 미수록 — 극희귀 단성 + 미등재 복성. 폴백 백엔드는 구조적으로 탐지 불가(누수 방지 핵심).
# CMP-262: 사전 3차 확장 후에도 미수록 성씨 비율 ≥ 0.5 유지(ML 백엔드 필요성 실측).
# 아래 성씨는 자연스러운 한글 음절이되 _SURNAMES/_COMPOUND_SURNAMES 에 의도적 미수록.
UNLISTED_SURNAMES = ["곤", "랑", "덕", "향", "응", "탐", "섬", "묘", "겹", "굴",
                     "숭", "훈", "검", "릉", "녕",
                     "달곤", "향섬", "응덕", "탐묘", "숭릉", "검향", "겹굴", "랑훈"]
